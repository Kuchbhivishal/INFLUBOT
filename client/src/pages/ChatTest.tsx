...
const ChatTest = () => {
  ...
  const setupInteraction = async () => {
    try {
      ...
      const response = await apiRequest("POST", "/api/test/interactions", {
              ...
              <CardFooter className="p-4 border-t bg-gray-50">
                <form onSubmit={handleSendMessage} className="flex w-full space-x-2">
                  <Input
                    ...
                    className="flex-grow"
                  />
                  <Button type="submit" disabled={!message.trim() || !interactionId}>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-sm">WebSocket: {socket?.readyState === WebSocket.OPEN ? "Connected" : "Disconnected"}</div>
